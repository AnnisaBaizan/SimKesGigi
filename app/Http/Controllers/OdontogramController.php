...
class OdontogramController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validatedData = $request->validate([
            ...
            'jumlah_tetap_d'=>'required|numeric|min:0|max:32',
            'jumlah_tetap_m'=>'required|numeric|min:0|max:32',
            'jumlah_tetap_f'=>'required|numeric|min:0|max:32',
            'dmf_t'=>'required|numeric|min:0|max:32',

            'jumlah_susu_d'=>'required|numeric|min:0|max:20',
            'jumlah_susu_e'=>'required|numeric|min:0|max:20',
            'jumlah_susu_f'=>'required|numeric|min:0|max:20',
            'def_t'=>'required|numeric|min:0|max:20',
