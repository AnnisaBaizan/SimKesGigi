...
@section('content')
    ...
    <main class="main-content  mt-0">
        ...
        <div class="col-lg-9 page-header align-items-start start-50 translate-middle-x min-vh-50 pt-5 pb-11 mt-3 border-radius-lg">
            <span class="mask bg-gradient-primary opacity-7"><img src="{{ asset('/img/GedungPoltekkes.png') }}" class="img-fluid position-absolute top-50 start-50 translate-middle"></span>
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-6 text-center mx-auto">
                        <h1 class="text-white mb-2 mt-5">Visi</h1>
                        <p class="text-lead text-white">Menjadi Institusi Pendidikan Tinggi Kesehatan yang Unggul dan Bermartabat di Tingkat Nasional tahun 2024</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="container">
            <div class="row mt-lg-n10 mt-md-n11 mt-n10 justify-content-center">
                <div class="col-xl-6 col-lg-9 col-md-7 mx-auto">
