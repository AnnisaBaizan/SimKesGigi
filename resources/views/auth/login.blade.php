                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="mt-2 col-xl-6 col-lg-6 col-md-6 d-flex flex-column mx-lg-0 mx-auto">
                            <div class="position-relative bg-gradient-primary h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center overflow-hidden">
                                ...
                                <p class="text-white position-relative">Menjadi Program Studi yang Menghasilkan Ahli Madya Kesehatan Gigi yang Bermartabat dengan Keunggulan di Bidang Pelayanan Asuhan Kesehatan Gigi dan Mulut Berbsis IT Tahun 2024</p>
                            </div>
                        </div>
