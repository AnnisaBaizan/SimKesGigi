<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 "
    ...
    <div class="collapse navbar-collapse  w-auto mt-2" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request::is('anomalimukosa*') ? 'active' : '' }}" href="{{ route('anomalimukosa.index') }}">
                    <div
                        class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="ni ni-vector text-success text-sm opacity-10"></i>
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request::is('periodontal*') ? 'active' : '' }}" href="{{ route('periodontal.index') }}">
                    <div
                        class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="ni ni-vector text-success text-sm opacity-10"></i>
                    </div>
                    <span class="nav-link-text ms-1">Periodontal</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request::is('askepgilut*') ? 'active' : '' }} " href="{{ route('askepgilut.index') }}">
                    <div
                        class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fas fa-window-restore text-dark text-sm opacity-10"></i>
                    </div>
                    <span class="nav-link-text ms-1">Askepgilut</span>
                </a>
            </li>
