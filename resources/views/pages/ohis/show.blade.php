                ...
                <hr class="my-4 w-100 border-top border-dark border-4 d-print-block">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="row">
                                <div class="col-sm-4 mb-3">
                                    ...
                                    <input type="text" name="jumlah_nilai_ci" id="jumlah_nilai_ci" value="{{ $ohis->jumlah_nilai_ci }}"
                                        class="form-control text-center" readonly required>
                                </div>
                                <div class="col-sm-4 mb-3">
                                    <label for="jumlah_gigi_ci">Jumlah Gigi CI</label>
                                    <input type="text" name="jumlah_gigi_ci" id="jumlah_gigi_ci" value="{{ $ohis->jumlah_gigi_ci }}"
                                        class="form-control text-center" readonly required>
                                </div>
                                <div class="col-sm-4 mb-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 mb-3">
                            <input type="text" name="nilai_kriteria_ohis" id="nilai_kriteria_ohis" value="{{ $ohis->nilai_kriteria_ohis }}"
                                class="form-control text-center" readonly required>
                        </div>
                        <div class="col-sm-6 mb-3">
                            <input type="text" name="kriteria_ohis" id="kriteria_ohis" value="{{ $ohis->kriteria_ohis }}"
                                class="form-control text-center" readonly required>
                        </div>
                    </div>
