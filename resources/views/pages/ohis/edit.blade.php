    ...
    <div class="container-fluid py-4">
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <form class="user" action="{{route('ohis.update', $ohis->id) }}" method="post">
                    @method('put')
                    @csrf
                  <div id="alert">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control @error('pembimbing') is-invalid_max @enderror"
                                    ...
                                    value="{{ $ohis->pembimbing }}" readonly required>
                                @error('pembimbing')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <select
                                    ...
                                    value="{{ old('kartupasien_id', $ohis->kartupasien_id) }}" required>
                    ...
                    <div class="col-sm-12 mb-3 mb-sm-0 text-center bg-gradient-faded-info-vertical">
                        <marquee>
                            <h6 class="m-0 font-weight-bold text-dark text-bold">DI (Debris Index) & CI (Calculus Index)
                            </h6>
                        </marquee>
                    </div>
                    {{--  --}}
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    ...
                                    <select class="form-control @error('di_1') is-invalid @enderror" id="di_1"
                                        name="di_1" placeholder="Tidak Ada" value="{{ old('di_1') }}">
                                        @error('di_1')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                        ...
                                        @for ($j = 0; $j < 4; $j++)
                                            <option value="{{ $j }}" {{ is_null($ohis->di_1) ? '' : ($ohis->di_1 == $j ? 'selected' : '') }}>{{ $j }}</option>
                                        @endfor
                                    </select>
                                </div>
                                <div class="col-sm-4">
                                    ...
                                    <select class="form-control @error('di_2') is-invalid @enderror" id="di_2"
                                        name="di_2" placeholder="Tidak Ada" value="{{ old('di_2') }}">
                                        @error('di_2')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                        ...
                                        <option value="" selected>Tidak Ada</option>
                                        @for ($j = 0; $j < 4; $j++)
                                            <option value="{{ $j }}" {{ is_null($ohis->di_2) ? '' : ($ohis->di_2 == $j ? 'selected' : '') }}>{{ $j }}</option>
                                        @endfor
                                    </select>
                                </div>
                                <div class="col-sm-4">
                                    ...
                                    <select class="form-control @error('di_3') is-invalid @enderror" id="di_3"
                                        name="di_3" placeholder="Tidak Ada" value="{{ old('di_3') }}">
                                        @error('di_3')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                        ...
                                        <option value="" selected>Tidak Ada</option>
                                        @for ($j = 0; $j < 4; $j++)
                                            <option value="{{ $j }}" {{ is_null($ohis->di_3) ? '' : ($ohis->di_3 == $j ? 'selected' : '') }}>{{ $j }}</option>
                                        @endfor
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-sm-4">
                                    ...
                                    <select class="form-control @error('di_4') is-invalid @enderror" id="di_4"
                                        name="di_4" placeholder="Tidak Ada" value="{{ old('di_4') }}">
                                        @error('di_4')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                        ...
                                        <option value="" selected>Tidak Ada</option>
                                        @for ($j = 0; $j < 4; $j++)
                                            <option value="{{ $j }}" {{ is_null($ohis->di_4) ? '' : ($ohis->di_4 == $j ? 'selected' : '') }}>{{ $j }}</option>
                                        @endfor
                                    </select>
                                </div>
                                <div class="col-sm-4">
                                    ...
                                    <select class="form-control @error('di_5') is-invalid @enderror" id="di_5"
                                        name="di_5" placeholder="Tidak Ada" value="{{ old('di_5') }}">
                                        @error('di_5')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                        ...
                                        <option value="" selected>Tidak Ada</option>
                                        @for ($j = 0; $j < 4; $j++)
                                            <option value="{{ $j }}" {{ is_null($ohis->di_5) ? '' : ($ohis->di_5 == $j ? 'selected' : '') }}>{{ $j }}</option>
                                        @endfor
                                    </select>
                                </div>
                                <div class="col-sm-4">
                                    ...
                                    <select class="form-control @error('di_6') is-invalid @enderror" id="di_6"
                                        name="di_6" placeholder="Tidak Ada" value="{{ old('di_6') }}">
                                        @error('di_6')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                        ...
                                        <option value="" selected>Tidak Ada</option>
                                        @for ($j = 0; $j < 4; $j++)
                                            <option value="{{ $j }}" {{ is_null($ohis->di_6) ? '' : ($ohis->di_6 == $j ? 'selected' : '') }}>{{ $j }}</option>
                                        @endfor
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-4 mb-3">
                                    ...
                                    <input type="text" name="jumlah_nilai_di" id="jumlah_nilai_di" value="0"
                                        class="form-control text-center" readonly required>
                                </div>
                                <div class="col-sm-4 mb-3">
                                    <label for="jumlah_gigi_di">Jumlah Gigi DI</label>
                                    <input type="text" name="jumlah_gigi_di" id="jumlah_gigi_di" value="0"
                                        class="form-control text-center" readonly required>
                                </div>
                                <div class="col-sm-4 mb-3">
                                    <label for="score_di">Score DI</label>
                                    <input type="text" name="score_di" id="score_di" value="0"
                                        class="form-control text-center" readonly required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    ...
                                    <select class="form-control @error('ci_1') is-invalid @enderror" id="ci_1"
                                        name="ci_1" placeholder="Tidak Ada" value="{{ old('ci_1') }}">
                                        @error('ci_1')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                        ...
                                        <option value="" selected>Tidak Ada</option>
                                        @for ($j = 0; $j < 4; $j++)
                                            <option value="{{ $j }}" {{ is_null($ohis->ci_1) ? '' : ($ohis->ci_1 == $j ? 'selected' : '') }}>{{ $j }}</option>
                                        @endfor
                                    </select>
                                </div>
                                <div class="col-sm-4">
                                    ...
                                    <select class="form-control @error('ci_2') is-invalid @enderror" id="ci_2"
                                        name="ci_2" placeholder="Tidak Ada" value="{{ old('ci_2') }}">
                                        @error('ci_2')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                        ...
                                        <option value="" selected>Tidak Ada</option>
                                        @for ($j = 0; $j < 4; $j++)
                                            <option value="{{ $j }}" {{ is_null($ohis->ci_2) ? '' : ($ohis->ci_2 == $j ? 'selected' : '') }}>{{ $j }}</option>
                                        @endfor
                                    </select>
                                </div>
                                <div class="col-sm-4">
                                    ...
                                    <select class="form-control @error('ci_3') is-invalid @enderror" id="ci_3"
                                        name="ci_3" placeholder="Tidak Ada" value="{{ old('ci_3') }}">
                                        @error('ci_3')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                        ...
                                        <option value="" selected>Tidak Ada</option>
                                        @for ($j = 0; $j < 4; $j++)
                                            <option value="{{ $j }}" {{ is_null($ohis->ci_3) ? '' : ($ohis->ci_3 == $j ? 'selected' : '') }}>{{ $j }}</option>
                                        @endfor
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-sm-4">
                                    ...
                                    <select class="form-control @error('ci_4') is-invalid @enderror" id="ci_4"
                                        name="ci_4" placeholder="Tidak Ada" value="{{ old('ci_4') }}">
                                        @error('ci_4')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                        ...
                                        <option value="" selected>Tidak Ada</option>
                                        @for ($j = 0; $j < 4; $j++)
                                            <option value="{{ $j }}" {{ is_null($ohis->ci_4) ? '' : ($ohis->ci_4 == $j ? 'selected' : '') }}>{{ $j }}</option>
                                        @endfor
                                    </select>
                                </div>
                                <div class="col-sm-4">
                                    ...
                                    <select class="form-control @error('ci_5') is-invalid @enderror" id="ci_5"
                                        name="ci_5" placeholder="Tidak Ada" value="{{ old('ci_5') }}">
                                        @error('ci_5')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                        ...
                                        <option value="" selected>Tidak Ada</option>
                                        @for ($j = 0; $j < 4; $j++)
                                            <option value="{{ $j }}" {{ is_null($ohis->ci_5) ? '' : ($ohis->ci_5 == $j ? 'selected' : '') }}>{{ $j }}</option>
                                        @endfor
                                    </select>
                                </div>
                                <div class="col-sm-4">
                                    ...
                                    <select class="form-control @error('ci_6') is-invalid @enderror" id="ci_6"
                                        name="ci_6" placeholder="Tidak Ada" value="{{ old('ci_6') }}">
                                        @error('ci_6')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                        ...
                                        <option value="" selected>Tidak Ada</option>
                                        @for ($j = 0; $j < 4; $j++)
                                            <option value="{{ $j }}" {{ is_null($ohis->ci_6) ? '' : ($ohis->ci_6 == $j ? 'selected' : '') }}>{{ $j }}</option>
                                        @endfor
                                    </select>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-4 mb-3">
                                    ...
                                    <input type="text" name="jumlah_nilai_ci" id="jumlah_nilai_ci" value="0"
                                        class="form-control text-center" readonly required>
                                </div>
                                <div class="col-sm-4 mb-3">
                                    <label for="jumlah_gigi_ci">Jumlah Gigi CI</label>
                                    <input type="text" name="jumlah_gigi_ci" id="jumlah_gigi_ci" value="0"
                                        class="form-control text-center" readonly required>
                                </div>
                                <div class="col-sm-4 mb-3">
                                    <label for="score_ci">Score CI</label>
                                    <input type="text" name="score_ci" id="score_ci" value="0"
                                        class="form-control text-center" readonly required>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 mb-3">
                            <input type="text" name="nilai_kriteria_ohis" id="nilai_kriteria_ohis" value="0"
                                class="form-control text-center" readonly required>
                        </div>
                        <div class="col-sm-6 mb-3">
                            <input type="text" name="kriteria_ohis" id="kriteria_ohis" value="Buruk"
                                class="form-control text-center" readonly required>
                        </div>
                    </div>
