                                ...
                                <tbody>
                                    @foreach ($ohiss as $ohis)
                                        <tr>
                                            ...
                                            @can('admin')
                                                <td>{{ $ohis->user->username }}</td>
                                                <td>{{ ucwords(get_v('users', 'nimnip', $ohis->user->pembimbing, 'username')[0]->username ?? '') }}
                                                </td>
                                            @endcan
                                            @can('mahasiswa')
                                                <td>{{ ucwords(get_v('users', 'nimnip', $ohis->user->pembimbing, 'username')[0]->username ?? '') }}
                                                ...
                                                @can('adminpembimbing')
                                                    @if ($ohis->acc == 0)
                                                        <a href="javascript:;" data-toggle="modal"
                                                            onclick="handleACC({{ $ohis->id }})" data-target="#AccModal"
                                            ...
                                            <td>
                                                @can('mahasiswa')
                                                    <label
                                                        class="{{ $ohis->acc == 0 ? 'btn btn-danger' : 'btn btn-success' }}">
                                            ...
                                            <td>
                                                ...
                                                <a href ="{{ route('ohis.show', $ohis->id) }}" title="show"
                                                ...
                                                @can('adminmahasiswa')
                                                    @if ($ohis->acc !== 1)
                                                        <a href ="{{ route('ohis.edit', $ohis->id) }}" title="Edit"
