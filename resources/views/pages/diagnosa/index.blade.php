                                    ...
                                    @foreach ($diagnosas as $diagnosa)
                                        <tr>
                                            ...
                                            @can('admin')
                                                ...
                                                <td>{{ ucwords(get_v('users', 'nimnip', $diagnosa->user->pembimbing, 'username')[0]->username ?? '') }}
                                                </td>
                                            @endcan
                                            @can('mahasiswa')
                                                <td>{{ ucwords(get_v('users', 'nimnip', $diagnosa->user->pembimbing, 'username')[0]->username ?? '') }}
                                            ...
                                            @can('pembimbing')
                                                <td>{{ $diagnosa->user->username }}</td>
                                            @endcan
                                            <td>{{ $diagnosa->kartupasien->no_kartu }} | {{ $diagnosa->kartupasien->nama }}
                                            </td>
                                                ...
                                                @can('adminpembimbing')
                                                    @if ($diagnosa->acc == 0)
                                                        <a href="javascript:;" data-toggle="modal"
                                                            onclick="handleACC({{ $diagnosa->id }})" data-target="#AccModal"
                                            ...
                                            <td>
                                                @can('mahasiswa')
                                                    <label
                                                        class="{{ $diagnosa->acc == 0 ? 'btn btn-danger' : 'btn btn-success' }}">
                                            ...
                                            <td>
                                                ...
                                                <a href ="{{ route('diagnosa.show', $diagnosa->id) }}" title="show"
                                                ...
                                                @can('adminmahasiswa')
                                                    @if ($diagnosa->acc !== 1)
                                                        <a href ="{{ route('diagnosa.edit', $diagnosa->id) }}" title="Edit"
                                                        ...
                                                        <a href="javascript:;" data-toggle="modal"
                                                            onclick="handleDelete({{ $diagnosa->id }})"
