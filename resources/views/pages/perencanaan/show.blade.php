        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body" id="printableArea">
                ...
                <div class="col-sm-12 text-center mb-3">
                    <h3 class="font-weight-bold text-dark text-center">Perencanaan</h3>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control"
                            value="{{ ucwords(get_v('users', 'id', $perencanaan->user_id, 'username')[0]->username ?? '') }}"
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control"
                            value="{{ ucwords(get_v('users', 'nimnip', $perencanaan->pembimbing, 'username')[0]->username ?? '') }}"
                            disabled readonly required>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control"
                            value="{{ ucwords(get_v('kartupasiens', 'id', $perencanaan->kartupasien_id, 'no_kartu')[0]->no_kartu ?? '') }}"
                            disabled readonly required>
                    </div>
                    <div class="col-sm-2">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control"
                            value="{{ ucwords(get_v('kartupasiens', 'id', $perencanaan->kartupasien_id, 'nama')[0]->nama ?? '') }}"
                            disabled readonly required>
                    </div>
                </div>
                ...
                @can('adminmahasiswa')
                    <div class="col-sm-12 mb-3 mb-sm-0 me-5 d-flex justify-content-end" style="width: 100%;">
                        <div class="ms-auto me-5">
                            ...
                            @endif
                            {{ ucwords(get_v('users', 'nimnip', $perencanaan->pembimbing, 'username')[0]->username ?? '') }}
                            <br>
                            NIP. {{ $perencanaan->pembimbing }}
                        </div>
                    </div>
                @endcan
            </div>
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        var qrText = "{{ $perencanaan->id }}" + "_" + "{{ $perencanaan->user_id }}" + "_" +
            "{{ $perencanaan->no_kartu }}" + "_" +
            "{{ $perencanaan->pembimbing }}" + "_" +
