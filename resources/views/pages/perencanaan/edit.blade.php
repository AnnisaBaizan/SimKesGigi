    ...
    <div class="container-fluid py-4">
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <form class="user" action="{{ route('perencanaan.update', $perencanaan->id) }}" method="post">
                    @method('put')
                    @csrf
                    <div id="alert">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <select class="js-example-basic-single form-control @error('user_id') is-invalid @enderror"
                                    ...
                                    @foreach ($users as $user)
                                        {{-- <option value="{{ $user->id }}" {{ $perencanaan->user_id == $user->id ? 'selected' : '' }} data-pembimbing="{{ $user->pembimbing }}"> --}}
                                        <option value="{{ $user->id }}" {{ $perencanaan->user_id == $user->id ? 'selected' : '' }}>
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control @error('pembimbing') is-invalid_max @enderror"
                                    id="pembimbing" name="pembimbing" placeholder="pembimbing" value="{{ $perencanaan->pembimbing }}" required>
                                @error('pembimbing')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-sm-8">
                                <select
                                    ...
                                    @foreach ($kartupasiens as $kartupasien)
                                        <option value="{{ $perencanaan->kartupasien_id }}"
                                            {{ $perencanaan->kartupasien_id == $kartupasien->id ? 'selected' : '' }} data-pembimbing="{{ $kartupasien->pembimbing }}">
                    ...
                    <div class="row text-center">
                        <div class="col-sm-2 mb-3">
                            ...
                            <select class="js-example-basic-single form-control @error('gigi') is-invalid @enderror"
                                data-live-search="true" id="gigi" name="gigi" placeholder="Pilih Elemen Gigi"
                                ...
                                <option value="{{ $gigi->kode }}" {{ $perencanaan->gigi == $gigi->kode ? 'selected' : '' }}>{{ $gigi->kode }}
                                </option>
                            @endforeach
                            </select>
                        </div>
                        ...
                        <div class="col-sm-5 mb-3">
                            ...
                            <textarea class="form-control @error('rasional') is-invalid @enderror" id="rasional" name="rasional"
                                placeholder="Masukan Rasional Anda">{{ old('rasional', $perencanaan->rasional) }}</textarea>
                            @error('rasional')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="col-sm-5 mb-3">
                            ...
                            <textarea class="form-control @error('kompetensi') is-invalid @enderror" id="kompetensi" name="kompetensi"
                                placeholder="Masukan Kompetensi Anda">{{ old('kompetensi', $perencanaan->kompetensi) }}</textarea>
                            @error('kompetensi')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="row text-center">
                        ...
                        <div class="col-sm-4 mb-3">
                            ...
                            <textarea class="form-control @error('tujuan') is-invalid @enderror" id="tujuan" name="tujuan"
                                placeholder="Masukan Tujuan Perawatan Anda">{{ old('tujuan', $perencanaan->tujuan) }}</textarea>
                            @error('tujuan')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="col-sm-4 mb-3">
                            ...
                            <textarea class="form-control @error('indikator') is-invalid @enderror" id="indikator" name="indikator"
                                placeholder="Masukan Indikator Keberhasilan Anda">{{ old('indikator', $perencanaan->indikator) }}</textarea>
                            @error('indikator')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="col-sm-4 mb-3">
                            ...
                            <textarea class="form-control @error('cara_evaluasi') is-invalid @enderror" id="cara_evaluasi" name="cara_evaluasi"
                                placeholder="Masukan Cara Evaluasi Anda">{{ old('cara_evaluasi', $perencanaan->cara_evaluasi) }}</textarea>
                            @error('cara_evaluasi')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
