        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p class="text-danger">ANDA AKAN MENGUBAH STATUS ACC SEMUA PEMERIKSAAN PERIODONTAL ATAS NAMA PASIEN INI</p>
                </div>
                <div class="modal-footer">
                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-header d-sm-flex align-items-center justify-content-between py-3">
                            ...
                            @can('adminmahasiswa')
                            <a href="{{route('periodontal.create')}}" class="d-sm-inline-block btn btn-primary btn-sm shadow-sm">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            @can('admin')
                                                ...
                                                <td>{{ ucwords(get_v('users', 'nimnip', $periodontal->user->pembimbing, 'username')[0]->username ?? "") }}</td>
                                            @endcan
                                            @can('mahasiswa')
                                                <td>{{ ucwords(get_v('users', 'nimnip', $periodontal->user->pembimbing, 'username')[0]->username ?? "") }}</td>
                                            @endcan
                                            ...
                                            <td style="display: none;">{{ $periodontal->attachment == 0 ? '-' : '+' }}</td> 
                                            <td style="display: none;">{{ $periodontal->pus == 0 ? '-' : '+' }}</td> 
                                            <td>{!! $periodontal->pocket_sakit == 0 ? '<i class="fas fa-minus-circle fa-2x"></i>' : '<i class="fas fa-plus-circle fa-2x"></i>' !!}</td>
                                            <td>{!! $periodontal->rubor == 0 ? '<i class="fas fa-minus-circle fa-2x"></i>' : '<i class="fas fa-plus-circle fa-2x"></i>' !!}</td>
                                            <td>{!! $periodontal->tumor == 0 ? '<i class="fas fa-minus-circle fa-2x"></i>' : '<i class="fas fa-plus-circle fa-2x"></i>' !!}</td>
                                            <td>{!! $periodontal->kolor == 0 ? '<i class="fas fa-minus-circle fa-2x"></i>' : '<i class="fas fa-plus-circle fa-2x"></i>' !!}</td>
                                            <td>{!! $periodontal->dolor == 0 ? '<i class="fas fa-minus-circle fa-2x"></i>' : '<i class="fas fa-plus-circle fa-2x"></i>' !!}</td>
                                            <td>{!! $periodontal->fungsio == 0 ? '<i class="fas fa-minus-circle fa-2x"></i>' : '<i class="fas fa-plus-circle fa-2x"></i>' !!}</td>
                                            <td>{!! $periodontal->attachment == 0 ? '<i class="fas fa-minus-circle fa-2x"></i>' : '<i class="fas fa-plus-circle fa-2x"></i>' !!}</td>
                                            <td>{!! $periodontal->pus == 0 ? '<i class="fas fa-minus-circle fa-2x"></i>' : '<i class="fas fa-plus-circle fa-2x"></i>' !!}</td>
                                            ...
                                            <td>
                                                @can('mahasiswa')
                                                    <label class="{{ $periodontal->acc == 0 ? 'btn btn-danger' : 'btn btn-success' }}">
                                            ...
                                            <td>
                                                ...
                                                <a href ="{{route('periodontal.show', $periodontal->id)}}" title="show" class="btn btn-sm btn-icon-split btn-primary">
                                                ...
                                                @can('adminmahasiswa')
                                                <a href ="{{route('periodontal.edit', $periodontal->id)}}" title="Edit" class="btn btn-sm btn-icon-split btn-warning">
                                                    <span class="icon"><i class="fas fa-pen text-white" style="padding-top: 4px;"></i></span><span class="text">Edit</span>
                                                </a>
                                                <a href="javascript:;" data-toggle="modal" onclick="handleDelete({{$periodontal->id}})" data-target="#DeleteModal" class="btn btn-sm btn-icon-split btn-danger">
