        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p class="text-danger">AKAN MENGHAPUS SELURUH DATA PASIEN, PEMERIKSAAN DAN HASIL YANG TERIKAT DENGAN USER INI</p>
                </div>
                ...
                <div class="modal-body">
                    <form action="{{ route('importuser') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" class="form-control-file" name="importuser" id="importuser" placeholder=""
            ...
            <div class="col-12">
                <div class="card mb-4">
                    ...
                    <div class="card-header d-sm-flex align-items-center">
                        ...
                        <button type="button" class="d-sm-inline-block btn btn-success btn-sm shadow-sm"
                                    ...
                                    @foreach ($users as $user)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @else
                                                    <span
                                                        class="badge badge-sm bg-gradient-light text-dark">Mahasiswa</span>
                                                @endif
                                            </td>
                                            <td>{{ ucwords(get_v('users', 'nimnip', $user->pembimbing, 'username')[0]->username ?? '') }}
                                            </td>
                                            {{-- <td>{{ $user->role }}</td> --}}
                                            <td><img src="{!! asset('/storage/avatars/' . $user->avatar) !!}" id="frame"
                                                    class="text-center img-preview mb-3 img-profile rounded-circle"
                                                    width="80px" height="80px" style="overflow:hidden"></td>
                                            <td>{{ date_format($user->created_at, 'd M Y') }}</td>
                                            <td>
                                                <a href ="{{ route('user.show', $user->id) }}" title="show"
