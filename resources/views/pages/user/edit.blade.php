    ...
    <div class="col-lg-8 container-fluid py-4">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Formulir Edit User</h6>
            </div>
            <div class="card-body">
                    ...
                    <div class="flex flex-col mb-3">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-8 mb-3 mb-sm-0">
                            <input type="text" class="form-control @error('nimnip') is-invalid @enderror" id="nimnip" name="nimnip" placeholder="Masukan NIM / NIP" value="{{ old('nimnip', $user->nimnip) }}" required>
                                @error('nimnip')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8 mb-3 mb-sm-0">
                              <input type="text" class="form-control @error('username') is-invalid @enderror" id="username" name="username" placeholder="Masukan Nama Lengkap + Gelar" value="{{ old('username', $user->username) }}" required>
                                  @error('username')
                                  <span class="invalid-feedback" role="alert">
                                  <strong>{{ $message }}</strong>
                                  </span>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-8 mb-3 mb-sm-0">
                              <input type="text" class="form-control @error('email') is-invalid @enderror" id="email" name="email" placeholder="Masukan Email" value="{{ old('email', $user->email) }}" required>
                                  @error('email')
                                  <span class="invalid-feedback" role="alert">
                                  <strong>{{ $message }}</strong>
                                  </span>
                        ...
                        <div class="form-group row" id="pembimbingContainer">
                            ...
                            <div class="col-sm-8">
                                <select class="js-example-basic-single form-control @error('pembimbing') is-invalid @enderror" data-live-search="true" id="pembimbing" name="pembimbing" placeholder="Pilih Pembimbing" value="{{ old('pembimbing') }}" required>
                                    @error('pembimbing')
                                    <span class="invalid-feedback" role="alert">
                                      <strong>{{ $message }}</strong>
                                    </span>
