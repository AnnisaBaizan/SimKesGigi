        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body" id="printableArea">
                ...
                <div class="col-sm-12 mb-3 mb-sm-0 text-center bg-gradient-faded-info-vertical">
                    <marquee>
                        <h6 class="m-0 font-weight-bold text-dark text-bold text-center">Vitalitas Gigi</h6>
                    </marquee>
                </div>
                ...
                <div class="row text-center">
                    ...
                    <div class="col-sm-2 mb-3">
                        ...
                        <select class="form-control text-center @error('thermis') is-invalid @enderror" id="thermis" name="thermis"
                            placeholder="75" value="{{ old('thermis') }}" disabled readonly>
                            @error('thermis')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="col-sm-2 mb-3">
                        ...
                        <select class="form-control text-center @error('sondasi') is-invalid @enderror" id="sondasi" name="sondasi"
                            placeholder="75" value="{{ old('sondasi') }}" disabled readonly>
                            @error('sondasi')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="col-sm-2 mb-3">
                        ...
                        <select class="form-control text-center @error('druk') is-invalid @enderror" id="druk" name="druk"
                            placeholder="75" value="{{ old('druk') }}" disabled readonly>
                            @error('druk')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="col-sm-2 mb-3">
                        ...
                        <select class="form-control text-center @error('mobility') is-invalid @enderror" id="mobility"
                            name="mobility" placeholder="75" value="{{ old('mobility') }}" disabled readonly>
                            @error('mobility')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
