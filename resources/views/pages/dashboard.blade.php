@extends('layouts.app', ['class' => 'g-sidenav-show bg-gray-100', 'titlePage' => 'Dashboard'])
                ...
                <div class="card">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Jumlah Pembimbing</p>
                ...
                <div class="card">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Jumlah Pasien Hari Ini</p>
                                    <h5 class="font-weight-bolder">
                                        {{ $kartupasien->count() }}
                                    </h5>
                                    {{-- <p class="mb-0">
                ...
                <div class="card">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Total Rekam Medik</p>
                                    <h5 class="font-weight-bolder">
                                        50
                                    </h5>
                                    {{-- <p class="mb-0">
                            ...
                            <div class="col-4 text-end">
                                <div class="icon icon-shape bg-gradient-warning shadow-warning text-center rounded-circle">
                                    <i class="fas fa-notes-medical text-lg opacity-10" aria-hidden="true"></i>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row mt-4">
                ...
                <div class="card shadow mb-4">
                  ...
                  <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    ...
                    {{-- <a href="" class="d-none d-sm-inline-block btn btn-primary btn-sm shadow-sm">
                      <i class="fas fa-plus fa-sm"></i> Tambah Pembimbing</a> --}}
                  </div>
                  <!-- Card Body -->
                  <div class="card-body">
                      <div class="table-responsive">
                          <table class="table table-bordered table-striped table-sm" id="pembimbing" width="100%" cellspacing="0">
                            <thead>
                              <tr>
                                <th>Nama</th>
                              <th>NIP</th>
                ...
                <div class="card card-carousel overflow-hidden h-100 p-0">
                    <div id="carouselExampleCaptions" class="carousel slide h-100" data-bs-ride="carousel">
                        <div class="carousel-inner border-radius-lg h-100">
                            <div class="carousel-item h-100 active img-fluid" style="background-image: url('./img/carousel-1.jpg');
            background-size: cover;">
                                <div class="carousel-caption d-none d-md-block bottom-0 text-start start-0 ms-5">
                                    <div class="icon icon-shape icon-sm bg-white text-center border-radius-md mb-3">
                                        <i class="ni ni-camera-compact text-dark opacity-10"></i>
                                    </div>
                                    <h5 class="text-white text-bold ">Visi Poltekkes</h5>
                                    <p class="text-white ">Menjadi Institusi Pendidikan Tinggi Kesehatan yang Unggul dan Bermartabat di Tingkat Nasional tahun 2024</p>
                                </div>
                            </div>
            ...
            background-size: cover;">
                                <div class="carousel-caption d-none d-md-block bottom-0 text-start start-0 ms-5">
                                    ...
                                    <h5 class="text-white text-bold ">Misi Jurusan Keperawatan Gigi</h5>
                                    <ul class="text-white ">
                                        <li>
                                            Lorem, ipsum dolor sit amet consectetur adipisicing elit. 
                                        </li>
                                        <li>
                                            Necessitatibus eius aliquid sit deleniti,
                                        </li>
                                        <li>
                                            blanditiis facilis eligendi quasi similique natus ad doloremque dolor consectetur,
                                        </li>
                                    </ul>
                                </div>
                            </div>
            ...
            <div class="col-lg-5 mb-4">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  ...
                  {{-- <a href="" class="d-none d-sm-inline-block btn btn-primary btn-sm shadow-sm">
                  <i class="fas fa-plus fa-sm"></i>Tambah Mahasiswa</a> --}}
                </div>
                <!-- Card Body -->
                <div class="card-body">
                  <div class="table-responsive">
                <table class="table table-bordered table-striped table-sm" id="mahasiswa" width="100%" cellspacing="0">
                  <thead>
                    <tr>
                        <th>Nama</th>
                      <th>NIM</th>
...
@push('js')
    ...
    <script>
        $(document).ready( function () {
            var table = $('#pembimbing').DataTable( {
              pageLength : 5,
