            ...
            <div id="printableArea">
                ...
                <div class="card-body">
                    ...
                    <form class="user" action="{{ route('anomalimukosa.update', $anomalimukosa->id) }}}" method="post">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <select
                                        ...
                                        data-live-search="true" id="kartupasien_id" name="kartupasien_id"
                        ...
                        @can('mahasiswa')
                            <div class="col-sm-6">
                                <input type="hidden" class="form-control @error('user_id') is-invalid_max @enderror"
                                    id="user_id" name="user_id" placeholder="user_id" value="{{ auth()->user()->id }}"
                                    required>
                                @error('user_id')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <select
                                        class="js-example-basic-single form-control @error('kartupasien_id') is-invalid @enderror"
                                        data-live-search="true" id="kartupasien_id" name="kartupasien_id"
                                        placeholder="Pilih Pasien" value="{{ old('kartupasien_id') }}" required>
                                        @error('kartupasien_id')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                            ...
                            <div class="col-sm-6">
                                ...
                                <select class="form-control @error('occlusi') is-invalid @enderror" id="occlusi"
                                    ...
                                    <option value="Normal bite"
                                        {{ $anomalimukosa->occlusi == 'Normal bite' ? 'selected' : '' }}>Normal bite</option>
                                    <option value="Cross bite"
                                        {{ $anomalimukosa->occlusi == 'Cross bite' ? 'selected' : '' }}>Cross bite</option>
                                    <option value="Steep bite"
                                        {{ $anomalimukosa->occlusi == 'Steep bite' ? 'selected' : '' }}>Steep bite</option>
                                </select>
                            </div>
                            <div class="col-sm-6">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <select class="form-control @error('struktur') is-invalid @enderror" id="struktur"
                                    ...
                                    @enderror
                                    <option value="" selected disabled>Pilih</option>
                                    <option value="Normal" {{ $anomalimukosa->struktur == 'Normal' ? 'selected' : '' }}>
                                        Normal</option>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3">
                                ...
                                <select class="form-control @error('w_lidah') is-invalid @enderror" id="w_lidah"
                                    ...
                                    <option value="Ada" {{ $anomalimukosa->w_lidah == 'Ada' ? 'selected' : '' }}>Ada
                                    </option>
                                    <option value="Tidak Ada"
                                        {{ $anomalimukosa->w_lidah == 'Tidak Ada' ? 'selected' : '' }}>Tidak Ada</option>
                                </select>
                            </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3">
                                ...
                                <select class="form-control @error('i_lidah') is-invalid @enderror" id="i_lidah"
                                    ...
                                    <option value="Ada" {{ $anomalimukosa->i_lidah == 'Ada' ? 'selected' : '' }}>Ada
                                    </option>
                                    <option value="Tidak Ada"
                                        {{ $anomalimukosa->i_lidah == 'Tidak Ada' ? 'selected' : '' }}>Tidak Ada</option>
                                </select>
                            </div>
                            <div class="col-sm-6 mb-3 mb-sm-0">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3">
                                ...
                                <select class="form-control @error('u_lidah') is-invalid @enderror" id="u_lidah"
                                    ...
                                    <option value="Ada" {{ $anomalimukosa->u_lidah == 'Ada' ? 'selected' : '' }}>Ada
                                    </option>
                                    <option value="Tidak Ada"
                                        {{ $anomalimukosa->u_lidah == 'Tidak Ada' ? 'selected' : '' }}>Tidak Ada</option>
                                </select>
                            </div>
                            <div class="col-sm-6 mb-3 mb-sm-0">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3">
                                ...
                                <select class="form-control @error('w_pipi') is-invalid @enderror" id="w_pipi"
                                    ...
                                    @enderror
                                    <option value="" selected disabled>Perubahan Warna</option>
                                    <option value="Ada" {{ $anomalimukosa->w_pipi == 'Ada' ? 'selected' : '' }}>Ada
                                    </option>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3">
                                ...
                                <select class="form-control @error('i_pipi') is-invalid @enderror" id="i_pipi"
                                    ...
                                    @enderror
                                    <option value="" selected disabled>Inflamasi</option>
                                    <option value="Ada" {{ $anomalimukosa->i_pipi == 'Ada' ? 'selected' : '' }}>Ada
                                    </option>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3">
                                ...
                                <select class="form-control @error('u_pipi') is-invalid @enderror" id="u_pipi"
                                    ...
                                    @enderror
                                    <option value="" selected disabled>Ulserasi</option>
                                    <option value="Ada" {{ $anomalimukosa->u_pipi == 'Ada' ? 'selected' : '' }}>Ada
                                    </option>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3">
                                ...
                                <select class="form-control @error('w_palatum') is-invalid @enderror" id="w_palatum"
                                    ...
                                    <option value="Tidak Ada"
                                        {{ $anomalimukosa->w_palatum == 'Tidak Ada' ? 'selected' : '' }}>Tidak Ada</option>
                                </select>
                            </div>
                            <div class="col-sm-6 mb-3 mb-sm-0">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3">
                                ...
                                <select class="form-control @error('i_palatum') is-invalid @enderror" id="i_palatum"
                                    ...
                                    <option value="Tidak Ada"
                                        {{ $anomalimukosa->i_palatum == 'Tidak Ada' ? 'selected' : '' }}>Tidak Ada</option>
                                </select>
                            </div>
                            <div class="col-sm-6 mb-3 mb-sm-0">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3">
                                ...
                                <select class="form-control @error('u_palatum') is-invalid @enderror" id="u_palatum"
                                    ...
                                    <option value="Tidak Ada"
                                        {{ $anomalimukosa->u_palatum == 'Tidak Ada' ? 'selected' : '' }}>Tidak Ada</option>
                                </select>
                            </div>
                            <div class="col-sm-6 mb-3 mb-sm-0">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3">
                                ...
                                <select class="form-control @error('w_gingiva') is-invalid @enderror" id="w_gingiva"
                                    ...
                                    <option value="Tidak Ada"
                                        {{ $anomalimukosa->w_gingiva == 'Tidak Ada' ? 'selected' : '' }}>Tidak Ada</option>
                                </select>
                            </div>
                            <div class="col-sm-6 mb-3 mb-sm-0">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3">
                                ...
                                <select class="form-control @error('i_gingiva') is-invalid @enderror" id="i_gingiva"
                                    ...
                                    <option value="Tidak Ada"
                                        {{ $anomalimukosa->i_gingiva == 'Tidak Ada' ? 'selected' : '' }}>Tidak Ada</option>
                                </select>
                            </div>
                            <div class="col-sm-6 mb-3 mb-sm-0">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3">
                                ...
                                <select class="form-control @error('u_gingiva') is-invalid @enderror" id="u_gingiva"
                                    ...
                                    <option value="Tidak Ada"
                                        {{ $anomalimukosa->u_gingiva == 'Tidak Ada' ? 'selected' : '' }}>Tidak Ada</option>
                                </select>
                            </div>
                            <div class="col-sm-6 mb-3 mb-sm-0">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3">
                                ...
                                <select class="form-control @error('w_bibir') is-invalid @enderror" id="w_bibir"
                                    ...
                                    <option value="Tidak Ada"
                                        {{ $anomalimukosa->w_bibir == 'Tidak Ada' ? 'selected' : '' }}>Tidak Ada</option>
                                </select>
                            </div>
                            <div class="col-sm-6 mb-3 mb-sm-0">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3">
                                ...
                                <select class="form-control @error('i_bibir') is-invalid @enderror" id="i_bibir"
                                    ...
                                    <option value="Tidak Ada"
                                        {{ $anomalimukosa->i_bibir == 'Tidak Ada' ? 'selected' : '' }}>Tidak Ada</option>
                                </select>
                            </div>
                            <div class="col-sm-6 mb-3 mb-sm-0">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3">
                                ...
                                <select class="form-control @error('u_bibir') is-invalid @enderror" id="u_bibir"
                                    ...
                                    <option value="Tidak Ada"
                                        {{ $anomalimukosa->u_bibir == 'Tidak Ada' ? 'selected' : '' }}>Tidak Ada</option>
                                </select>
                            </div>
                            <div class="col-sm-6 mb-3 mb-sm-0">
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        var qrText = "{{ $anomalimukosa->user_id }}" + "_" + "{{ $anomalimukosa->no_kartu }}" + "_" +
