            ...
            <div class="card-body" id="printableArea">
                    ...
                    <div class="form-group row mt-3">
                        ...
                        <div class="form-floating custom-col custom-col-sm-1">
                            <select class="form-control @error('kode_55') is-invalid @enderror" id="kode_55"
                                name="kode_55" placeholder="55" value="{{ old('kode_55') }}" disabled readonly>
                                @error('kode_55')
                        ...
                        <div class="form-floating custom-col custom-col-sm-1">
                            <select class="form-control @error('kode_54') is-invalid @enderror" id="kode_54"
                                name="kode_54" placeholder="54" value="{{ old('kode_54') }}" disabled readonly>
                                @error('kode_54')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-floating custom-col custom-col-sm-1">
                            <select class="form-control @error('kode_53') is-invalid @enderror" id="kode_53"
                                name="kode_53" placeholder="53" value="{{ old('kode_53') }}" disabled readonly>
                                @error('kode_53')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-floating custom-col custom-col-sm-1">
                            <select class="form-control @error('kode_52') is-invalid @enderror" id="kode_52"
                                name="kode_52" placeholder="52" value="{{ old('kode_52') }}" disabled readonly>
                                @error('kode_52')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-floating custom-col custom-col-sm-1">
                            <select class="form-control @error('kode_51') is-invalid @enderror" id="kode_51"
                                name="kode_51" placeholder="51" value="{{ old('kode_51') }}" disabled readonly>
                                @error('kode_51')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-floating custom-col custom-col-sm-1">
                            <select class="form-control @error('kode_61') is-invalid @enderror" id="kode_61"
                                name="kode_61" placeholder="61" value="{{ old('kode_61') }}" disabled readonly>
                                @error('kode_61')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-floating custom-col custom-col-sm-1">
                            <select class="form-control @error('kode_62') is-invalid @enderror" id="kode_62"
                                name="kode_62" placeholder="62" value="{{ old('kode_62') }}" disabled readonly>
                                @error('kode_62')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-floating custom-col custom-col-sm-1">
                            <select class="form-control @error('kode_63') is-invalid @enderror" id="kode_63"
                                name="kode_63" placeholder="63" value="{{ old('kode_63') }}" disabled readonly>
                                @error('kode_63')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-floating custom-col custom-col-sm-1">
                            <select class="form-control @error('kode_64') is-invalid @enderror" id="kode_64"
                                name="kode_64" placeholder="64" value="{{ old('kode_64') }}" disabled readonly>
                                @error('kode_64')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-floating custom-col custom-col-sm-1">
                            <select class="form-control @error('kode_65') is-invalid @enderror" id="kode_65"
                                name="kode_65" placeholder="65" value="{{ old('kode_65') }}" disabled readonly>
                                @error('kode_65')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                    ...
                    <div class="form-group row mt-3">
                        <div class="form-floating custom-col custom-col-sm-1">
                            <select class="form-control @error('kode_18') is-invalid @enderror" id="kode_18"
                                name="kode_18" placeholder="18" value="{{ old('kode_18') }}" disabled readonly>
                                @error('kode_18')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-floating custom-col custom-col-sm-1">
                            <select class="form-control @error('kode_17') is-invalid @enderror" id="kode_17"
                                name="kode_17" placeholder="17" value="{{ old('kode_17') }}" disabled readonly>
                                @error('kode_17')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-floating custom-col custom-col-sm-1">
                            <select class="form-control @error('kode_16') is-invalid @enderror" id="kode_16"
                                name="kode_16" placeholder="16" value="{{ old('kode_16') }}" disabled readonly>
                                @error('kode_16')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-floating custom-col custom-col-sm-1">
                            <select class="form-control @error('kode_15') is-invalid @enderror" id="kode_15"
                                name="kode_15" placeholder="15" value="{{ old('kode_15') }}" disabled readonly>
                                @error('kode_15')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-floating custom-col custom-col-sm-1">
                            <select class="form-control @error('kode_14') is-invalid @enderror" id="kode_14"
                                name="kode_14" placeholder="14" value="{{ old('kode_14') }}" disabled readonly>
                                @error('kode_14')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-floating custom-col custom-col-sm-1">
                            <select class="form-control @error('kode_13') is-invalid @enderror" id="kode_13"
                                name="kode_13" placeholder="13" value="{{ old('kode_13') }}" disabled readonly>
                                @error('kode_13')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-floating custom-col custom-col-sm-1">
                            <select class="form-control @error('kode_12') is-invalid @enderror" id="kode_12"
                                name="kode_12" placeholder="12" value="{{ old('kode_12') }}" disabled readonly>
                                @error('kode_12')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-floating custom-col custom-col-sm-1">
                            <select class="form-control @error('kode_11') is-invalid @enderror" id="kode_11"
                                name="kode_11" placeholder="11" value="{{ old('kode_11') }}" disabled readonly>
                                @error('kode_11')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-floating custom-col custom-col-sm-1">
                            <select class="form-control @error('kode_21') is-invalid @enderror" id="kode_21"
                                name="kode_21" placeholder="21" value="{{ old('kode_21') }}" disabled readonly>
                                @error('kode_21')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-floating custom-col custom-col-sm-1">
                            <select class="form-control @error('kode_22') is-invalid @enderror" id="kode_22"
                                name="kode_22" placeholder="22" value="{{ old('kode_22') }}" disabled readonly>
                                @error('kode_22')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-floating custom-col custom-col-sm-1">
                            <select class="form-control @error('kode_23') is-invalid @enderror" id="kode_23"
                                name="kode_23" placeholder="23" value="{{ old('kode_23') }}" disabled readonly>
                                @error('kode_23')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-floating custom-col custom-col-sm-1">
                            <select class="form-control @error('kode_24') is-invalid @enderror" id="kode_24"
                                name="kode_24" placeholder="24" value="{{ old('kode_24') }}" disabled readonly>
                                @error('kode_24')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-floating custom-col custom-col-sm-1">
                            <select class="form-control @error('kode_25') is-invalid @enderror" id="kode_25"
                                name="kode_25" placeholder="25" value="{{ old('kode_25') }}" disabled readonly>
                                @error('kode_25')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-floating custom-col custom-col-sm-1">
                            <select class="form-control @error('kode_26') is-invalid @enderror" id="kode_26"
                                name="kode_26" placeholder="26" value="{{ old('kode_26') }}" disabled readonly>
                                @error('kode_26')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-floating custom-col custom-col-sm-1">
                            <select class="form-control @error('kode_27') is-invalid @enderror" id="kode_27"
                                name="kode_27" placeholder="27" value="{{ old('kode_27') }}" disabled readonly>
                                @error('kode_27')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-floating custom-col custom-col-sm-1">
                            <select class="form-control @error('kode_28') is-invalid @enderror" id="kode_28"
                                name="kode_28" placeholder="28" value="{{ old('kode_28') }}" disabled readonly>
                                @error('kode_28')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                    ...
                    <div class="form-group row mt-3">
                        <div class="form-floating custom-col custom-col-sm-1">
                            <select class="form-control @error('kode_48') is-invalid @enderror" id="kode_48"
                                name="kode_48" placeholder="48" value="{{ old('kode_48') }}" disabled readonly>
                                @error('kode_48')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-floating custom-col custom-col-sm-1">
                            <select class="form-control @error('kode_47') is-invalid @enderror" id="kode_47"
                                name="kode_47" placeholder="47" value="{{ old('kode_47') }}" disabled readonly>
                                @error('kode_47')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-floating custom-col custom-col-sm-1">
                            <select class="form-control @error('kode_46') is-invalid @enderror" id="kode_46"
                                name="kode_46" placeholder="46" value="{{ old('kode_46') }}" disabled readonly>
                                @error('kode_46')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-floating custom-col custom-col-sm-1">
                            <select class="form-control @error('kode_45') is-invalid @enderror" id="kode_45"
                                name="kode_45" placeholder="45" value="{{ old('kode_45') }}" disabled readonly>
                                @error('kode_45')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-floating custom-col custom-col-sm-1">
                            <select class="form-control @error('kode_44') is-invalid @enderror" id="kode_44"
                                name="kode_44" placeholder="44" value="{{ old('kode_44') }}" disabled readonly>
                                @error('kode_44')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-floating custom-col custom-col-sm-1">
                            <select class="form-control @error('kode_43') is-invalid @enderror" id="kode_43"
                                name="kode_43" placeholder="43" value="{{ old('kode_43') }}" disabled readonly>
                                @error('kode_43')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-floating custom-col custom-col-sm-1">
                            <select class="form-control @error('kode_42') is-invalid @enderror" id="kode_42"
                                name="kode_42" placeholder="42" value="{{ old('kode_42') }}" disabled readonly>
                                @error('kode_42')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-floating custom-col custom-col-sm-1">
                            <select class="form-control @error('kode_41') is-invalid @enderror" id="kode_41"
                                name="kode_41" placeholder="41" value="{{ old('kode_41') }}" disabled readonly>
                                @error('kode_41')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-floating custom-col custom-col-sm-1">
                            <select class="form-control @error('kode_31') is-invalid @enderror" id="kode_31"
                                name="kode_31" placeholder="31" value="{{ old('kode_31') }}" disabled readonly>
                                @error('kode_31')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-floating custom-col custom-col-sm-1">
                            <select class="form-control @error('kode_32') is-invalid @enderror" id="kode_32"
                                name="kode_32" placeholder="32" value="{{ old('kode_32') }}" disabled readonly>
                                @error('kode_32')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-floating custom-col custom-col-sm-1">
                            <select class="form-control @error('kode_33') is-invalid @enderror" id="kode_33"
                                name="kode_33" placeholder="33" value="{{ old('kode_33') }}" disabled readonly>
                                @error('kode_33')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-floating custom-col custom-col-sm-1">
                            <select class="form-control @error('kode_34') is-invalid @enderror" id="kode_34"
                                name="kode_34" placeholder="34" value="{{ old('kode_34') }}" disabled readonly>
                                @error('kode_34')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-floating custom-col custom-col-sm-1">
                            <select class="form-control @error('kode_35') is-invalid @enderror" id="kode_35"
                                name="kode_35" placeholder="35" value="{{ old('kode_35') }}" disabled readonly>
                                @error('kode_35')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-floating custom-col custom-col-sm-1">
                            <select class="form-control @error('kode_36') is-invalid @enderror" id="kode_36"
                                name="kode_36" placeholder="36" value="{{ old('kode_36') }}" disabled readonly>
                                @error('kode_36')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-floating custom-col custom-col-sm-1">
                            <select class="form-control @error('kode_37') is-invalid @enderror" id="kode_37"
                                name="kode_37" placeholder="37" value="{{ old('kode_37') }}" disabled readonly>
                                @error('kode_37')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-floating custom-col custom-col-sm-1">
                            <select class="form-control @error('kode_38') is-invalid @enderror" id="kode_38"
                                name="kode_38" placeholder="38" value="{{ old('kode_38') }}" disabled readonly>
                                @error('kode_38')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                    ...
                    <div class="form-group row mt-3">
                        ...
                        <div class="form-floating custom-col custom-col-sm-1">
                            <select class="form-control @error('kode_85') is-invalid @enderror" id="kode_85"
                                name="kode_85" placeholder="85" value="{{ old('kode_85') }}" disabled readonly>
                                @error('kode_85')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-floating custom-col custom-col-sm-1">
                            <select class="form-control @error('kode_84') is-invalid @enderror" id="kode_84"
                                name="kode_84" placeholder="84" value="{{ old('kode_84') }}" disabled readonly>
                                @error('kode_84')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-floating custom-col custom-col-sm-1">
                            <select class="form-control @error('kode_83') is-invalid @enderror" id="kode_83"
                                name="kode_83" placeholder="83" value="{{ old('kode_83') }}" disabled readonly>
                                @error('kode_83')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-floating custom-col custom-col-sm-1">
                            <select class="form-control @error('kode_82') is-invalid @enderror" id="kode_82"
                                name="kode_82" placeholder="82" value="{{ old('kode_82') }}" disabled readonly>
                                @error('kode_82')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-floating custom-col custom-col-sm-1">
                            <select class="form-control @error('kode_81') is-invalid @enderror" id="kode_81"
                                name="kode_81" placeholder="81" value="{{ old('kode_81') }}" disabled readonly>
                                @error('kode_81')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-floating custom-col custom-col-sm-1">
                            <select class="form-control @error('kode_71') is-invalid @enderror" id="kode_71"
                                name="kode_71" placeholder="71" value="{{ old('kode_71') }}" disabled readonly>
                                @error('kode_71')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-floating custom-col custom-col-sm-1">
                            <select class="form-control @error('kode_72') is-invalid @enderror" id="kode_72"
                                name="kode_72" placeholder="72" value="{{ old('kode_72') }}" disabled readonly>
                                @error('kode_72')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-floating custom-col custom-col-sm-1">
                            <select class="form-control @error('kode_73') is-invalid @enderror" id="kode_73"
                                name="kode_73" placeholder="73" value="{{ old('kode_73') }}" disabled readonly>
                                @error('kode_73')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-floating custom-col custom-col-sm-1">
                            <select class="form-control @error('kode_74') is-invalid @enderror" id="kode_74"
                                name="kode_74" placeholder="74" value="{{ old('kode_74') }}" disabled readonly>
                                @error('kode_74')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-floating custom-col custom-col-sm-1">
                            <select class="form-control @error('kode_75') is-invalid @enderror" id="kode_75"
                                name="kode_75" placeholder="75" value="{{ old('kode_75') }}" disabled readonly>
                                @error('kode_75')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                ...
                <div class="row text-center">
                    <div class="col-sm-2 mb-3">
                        ...
                        <input type="text" name="jumlah_tetap_d" id="jumlah_tetap_d"
                            value="{{ $odontogram->jumlah_tetap_d }}" class="form-control text-center" readonly
                            required>
                    </div>
                    <div class="col-sm-1 mb-3">
                        <label>+</label>
                        <input value="+" class="form-control text-center bg-gradient-faded-info-vertical" readonly
                            disabled required>
                    </div>
                    <div class="col-sm-2 mb-3">
                        <label for="jumlah_tetap_m">M</label>
                        <input type="text" name="jumlah_tetap_m" id="jumlah_tetap_m"
                            value="{{ $odontogram->jumlah_tetap_m }}" class="form-control text-center" readonly
                            required>
                    </div>
                    <div class="col-sm-1 mb-3">
                        <label>+</label>
                    ...
                    <div class="col-sm-2 mb-3">
                        ...
                        <input type="text" name="jumlah_tetap_f" id="jumlah_tetap_f"
                            value="{{ $odontogram->jumlah_tetap_f }}" class="form-control text-center" readonly
                            required>
                    </div>
                    <div class="col-sm-1 mb-3">
                        <label>=</label>
                ...
                <div class="row text-center">
                    <div class="col-sm-2 mb-3">
                        ...
                        <input type="text" name="jumlah_susu_d" id="jumlah_susu_d"
                            value="{{ $odontogram->jumlah_susu_d }}" class="form-control text-center" readonly required>
                    </div>
                    <div class="col-sm-1 mb-3">
                        <label>+</label>
                        <input value="+" class="form-control text-center bg-gradient-faded-info-vertical" readonly
                    ...
                    <div class="col-sm-2 mb-3">
                        ...
                        <input type="text" name="jumlah_susu_e" id="jumlah_susu_e"
                            value="{{ $odontogram->jumlah_susu_e }}" class="form-control text-center" readonly required>
                    </div>
                    <div class="col-sm-1 mb-3">
                        <label>+</label>
                        <input value="+" class="form-control text-center bg-gradient-faded-info-vertical" readonly
                    ...
                    <div class="col-sm-2 mb-3">
                        ...
                        <input type="text" name="jumlah_susu_f" id="jumlah_susu_f"
                            value="{{ $odontogram->jumlah_susu_f }}" class="form-control text-center" readonly required>
                    </div>
                    <div class="col-sm-1 mb-3">
                        <label>=</label>
                        <input value="=" class="form-control text-center bg-gradient-faded-info-vertical" readonly
...
@section('js')
    ...
    <script>
        function printDiv(divName) {
            ...
            // Aturan cetak CSS langsung ditambahkan di dalam fungsi printDiv()
            var printCSS = `
                @page {
                    size: landscape;
                }
                ...
                .custom-col-sm-1 {
                    width: 6.25%; /* Atur ulang lebar kolom untuk cetak */
                }
    
                .custom-col-sm-2 {
                    width: 18.75%; /* Atur ulang lebar kolom untuk cetak */
                }
    
                .custom-col-sm-3 {
                    width: 12%; /* Atur ulang lebar kolom untuk cetak */
                }
    
                .custom-col-sm-4 {
                    width: 28%; /* Atur ulang lebar kolom untuk cetak */
                }
                /* Anda dapat menambahkan aturan cetak tambahan di sini */
            `;

            // Gabungkan aturan cetak CSS dengan konten cetak
            var printHTML = '<html><head><style>' + printCSS + '</style></head><body>' + printContents + '</body></html>';
