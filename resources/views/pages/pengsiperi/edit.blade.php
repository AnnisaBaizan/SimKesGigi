...
@section('content')
    @include('layouts.navbars.auth.topnav', [
        'title' => 'Edit Pengetahuan, Keterampilan, Perilaku dan Peran Orang Tua',
    ])
    ...
    <div class="container-fluid py-4">
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form class="user" action="{{ route('pengsiperi.update', $pengsiperi->id) }}" method="post">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control @error('pembimbing') is-invalid_max @enderror"
                                    id="pembimbing" name="pembimbing" placeholder="pembimbing" value="{{ $pengsiperi->pembimbing }}" readonly required>
                                @error('pembimbing')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <select
                                    ...
                                    value="{{ old('kartupasien_id', $pengsiperi->kartupasien_id) }}" required>
                        ...
                        <div class="col-sm-7 mb-3">
                            <select
                                ...
                                @foreach ($pengetahuans as $pengetahuan)
                                    <option value="{{ $pengetahuan->id }}" {{ in_array($pengetahuan->id, explode(',', $pengsiperi->pengetahuan)) ? 'selected' : '' }}>{{ $pengetahuan->soal }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-2 mb-sm-0 text-center">
                            <input type="radio" id="labialbukal1" name="labialbukal" value="1" {{ $pengsiperi->labialbukal == 1 ? 'checked' : '' }}>
                        </div>
                        <div class="col-sm-2 mb-sm-0 text-center">
                            <input type="radio" id="labialbukal2" name="labialbukal" value="2" {{ $pengsiperi->labialbukal == 2 ? 'checked' : '' }}>
                        </div>
                        <div class="col-sm-1 mb-sm-0 text-center">
                            <input type="radio" id="labialbukal3" name="labialbukal" value="3" {{ $pengsiperi->labialbukal == 3 ? 'checked' : '' }}>
                        </div>
                        <div class="col-sm-2 mb-sm-0 text-center">
                            <input type="radio" id="labialbukal4" name="labialbukal" value="4" {{ $pengsiperi->labialbukal == 4 ? 'checked' : '' }}>
                        </div>
                        <div class="col-sm-2 mb-sm-0 text-center">
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-2 mb-sm-0 text-center">
                            <input type="radio" id="lingualpalatal1" name="lingualpalatal" value="1" {{ $pengsiperi->lingualpalatal == 1 ? 'checked' : '' }}>
                        </div>
                        <div class="col-sm-2 mb-sm-0 text-center">
                            <input type="radio" id="lingualpalatal2" name="lingualpalatal" value="2" {{ $pengsiperi->lingualpalatal == 2 ? 'checked' : '' }}>
                        </div>
                        <div class="col-sm-1 mb-sm-0 text-center">
                            <input type="radio" id="lingualpalatal3" name="lingualpalatal" value="3" {{ $pengsiperi->lingualpalatal == 3 ? 'checked' : '' }}>
                        </div>
                        <div class="col-sm-2 mb-sm-0 text-center">
                            <input type="radio" id="lingualpalatal4" name="lingualpalatal" value="4" {{ $pengsiperi->lingualpalatal == 4 ? 'checked' : '' }}>
                        </div>
                        <div class="col-sm-2 mb-sm-0 text-center">
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-2 mb-sm-0 text-center">
                            <input type="radio" id="kunyah1" name="kunyah" value="1" {{ $pengsiperi->kunyah == 1 ? 'checked' : '' }}>
                        </div>
                        <div class="col-sm-2 mb-sm-0 text-center">
                            <input type="radio" id="kunyah2" name="kunyah" value="2" {{ $pengsiperi->kunyah == 2 ? 'checked' : '' }}>
                        </div>
                        <div class="col-sm-1 mb-sm-0 text-center">
                            <input type="radio" id="kunyah3" name="kunyah" value="3" {{ $pengsiperi->kunyah == 3 ? 'checked' : '' }}>
                        </div>
                        <div class="col-sm-2 mb-sm-0 text-center">
                            <input type="radio" id="kunyah4" name="kunyah" value="4" {{ $pengsiperi->kunyah == 4 ? 'checked' : '' }}>
                        </div>
                        <div class="col-sm-2 mb-sm-0 text-center">
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-2 mb-sm-0 text-center">
                            <input type="radio" id="interdental1" name="interdental" value="1" {{ $pengsiperi->interdental == 1 ? 'checked' : '' }}>
                        </div>
                        <div class="col-sm-2 mb-sm-0 text-center">
                            <input type="radio" id="interdental2" name="interdental" value="2" {{ $pengsiperi->interdental == 2 ? 'checked' : '' }}>
                        </div>
                        <div class="col-sm-1 mb-sm-0 text-center">
                            <input type="radio" id="interdental3" name="interdental" value="3" {{ $pengsiperi->interdental == 3 ? 'checked' : '' }}>
                        </div>
                        <div class="col-sm-2 mb-sm-0 text-center">
                            <input type="radio" id="interdental4" name="interdental" value="4" {{ $pengsiperi->interdental == 4 ? 'checked' : '' }}>
                        </div>
                        <div class="col-sm-2 mb-sm-0 text-center">
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-2 mb-sm-0 text-center">
                            <input type="radio" id="gerakan1" name="gerakan" value="1" {{ $pengsiperi->gerakan == 1 ? 'checked' : '' }}>
                            <label for="gerakan1">Cepat</label>
                        </div>
                        <div class="col-sm-2 mb-sm-0 text-center">
                            <input type="radio" id="gerakan2" name="gerakan" value="2" {{ $pengsiperi->gerakan == 2 ? 'checked' : '' }}>
                            <label for="gerakan2">Lambat</label>
                        </div>
                        <div class="col-sm-2 mb-sm-0 text-center">
                            <input type="radio" id="gerakan3" name="gerakan" value="3" {{ $pengsiperi->gerakan == 3 ? 'checked' : '' }}>
                        ...
                        <div class="col-sm-9 mb-3">
                            <select class="js-example-basic-multiple form-control @error('perilaku') is-invalid @enderror"
                                ...
                                @foreach ($perilakus as $perilaku)
                                    <option value="{{ $perilaku->id }}" {{ in_array($perilaku->id, explode(',', $pengsiperi->perilaku)) ? 'selected' : '' }}>{{ $perilaku->soal }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group row mb-3 mt-3">
                        ...
                        <div class="col-sm-3 mb-sm-0 text-center">
                            <input type="checkbox" id="peran_ortu1" name="peran_ortu[]" value="1" {{ in_array(1, explode(',', $pengsiperi->peran_ortu)) ? 'checked' : '' }}>
                            <label for="peran_ortu1">Mendampingi menggosok gigi</label>
                        </div>
                        <div class="col-sm-3 mb-sm-0 text-center">
                            <input type="checkbox" id="peran_ortu2" name="peran_ortu[]" value="2" {{ in_array(2, explode(',', $pengsiperi->peran_ortu)) ? 'checked' : '' }}>
                            <label for="peran_ortu2">Memerintahkan menggosok gigi</label>
                        </div>
                        <div class="col-sm-4 mb-sm-0 text-center">
                            <input type="checkbox" id="peran_ortu3" name="peran_ortu[]" value="3" {{ in_array(3, explode(',', $pengsiperi->peran_ortu)) ? 'checked' : '' }}>
