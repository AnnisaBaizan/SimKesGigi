            ...
            <div class="card-body">
                <form class="user" action="{{route('pengsiperi.store')}}" method="post">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-7 mb-3">
                        <input type="text" class="form-control" id="jumlah_pertanyaan_peng" name="jumlah_pertanyaan_peng" readonly>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-7 mb-3">
                        <input type="text" class="form-control" id="jawaban_benar_peng" name="jawaban_benar_peng" readonly>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <div class="col-sm-12 mb-3">
                        <input type="text" class="form-control text-center" id="kesimpulan" name="kesimpulan" readonly>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9 mb-3">
                        <input type="text" name="jumlah_yang_terpilih" value="" class="form-control" readonly>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9 mb-3">
                        <input type="text" name="nilai_peri" value="" class="form-control" readonly>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9 mb-3">
                        <input type="text" name="berperilaku" value="" class="form-control bg-success" readonly>
                    </div>
                </div>
...
<script>
    $(document).ready(function() {
        ...
        function hitungNilai() {
            ...
            $('input[name="kriteria"]').removeClass('bg-success bg-warning bg-danger'); // Hapus kelas background color sebelum mengganti
...
$("[name='labialbukal'], [name='lingualpalatal'], [name='kunyah'], [name='interdental'], [name='gerakan']").on('change', function() {
    updateKesimpulan();
});
    ...
    <script>
        $(document).ready(function() {
            ...
            function hitungPerilaku() {
                ...
                $('input[name="berperilaku"]').removeClass('bg-success bg-danger'); // Hapus kelas background color sebelum mengganti
