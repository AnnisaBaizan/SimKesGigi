            ...
            <div class="card-body">
                ...
                {{-- <div class="col-sm-12 mb-3">
                  ...
                  <div class="form-group row">
                    <div class="col-sm-12 mb-3">
                      <label for="kartupasien_id" class ="form-text">Pilih Pasien :</label>
                      <select class="form-control  @error('kartupasien_id') is-invalid @enderror" data-live-search="true" id="kartupasien_id" name="kartupasien_id" placeholder="Pilih Pasien" value="{{ old('kartupasien_id') }}" required disabled readonly>
                              @error('kartupasien_id')
                              <span class="invalid-feedback" role="alert">
                              <strong>{{ $message }}</strong>
                              </span>
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control @error('klhn_utama') is-invalid @enderror" id="klhn_utama" name="klhn_utama" disabled readonly placeholder="Masukan Keluhan Utama Anda">{{ old('klhn_utama', $anamripasien->klhn_utama) }}</textarea>
                        @error('klhn_utama')
                        <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <div class="col-sm-12 mb-3 mb-sm-0">
                      ...
                      <textarea class="form-control @error('klhn_tmbhn') is-invalid @enderror" id="klhn_tmbhn" name="klhn_tmbhn" disabled readonly placeholder="Masukan Keluhan Tambahan Anda">{{ old('klhn_tmbhn', $anamripasien->klhn_tmbhn) }}</textarea>
                          @error('klhn_tmbhn')
                          <span class="invalid-feedback" role="alert">
                          <strong>{{ $message }}</strong>
                          </span>
                  ...
                  <div class="form-group row">
                    <div class="col-sm-6 mb-3">
                      ...
                      <select class="form-control @error('goldar') is-invalid @enderror" id="goldar" name="goldar" disabled readonly placeholder="Golongan Darah" value="{{ old('goldar') }}" required>
                              @error('goldar')
                              <span class="invalid-feedback" role="alert">
                              <strong>{{ $message }}</strong>
                              </span>
                    ...
                    <div class="col-sm-4 mb-3 mb-sm-0">
                      ...
                      <input type="text" class="form-control @error('nadi') is-invalid @enderror" id="nadi" name="nadi" placeholder="Denyut Nadi" value="{{ old('nadi', $anamripasien->nadi) }}" required disabled readonly>
                          @error('nadi')
                          <span class="invalid-feedback" role="alert">
                          <strong>{{ $message }}</strong>
                          </span>
                    ...
                    <div class="form-group row">
                      <div class="col-sm-4 mb-3 mb-sm-0">
                          ...
                          <input type="text" class="form-control @error('tknn_drh') is-invalid @enderror" id="tknn_drh" name="tknn_drh" placeholder="00/00" value="{{ old('tknn_drh', $anamripasien->tknn_drh) }}" required disabled readonly>
                              @error('tknn_drh')
                              <span class="invalid-feedback" role="alert">
                              <strong>{{ $message }}</strong>
                              </span>
                      ...
                      <div class="col-sm-6 mb-3">
                        ...
                        <select class="form-control @error('ktrgn_drh') is-invalid @enderror" id="ktrgn_drh" name="ktrgn_drh" placeholder="Keterangan" value="{{ old('ktrgn_drh') }}" required disabled readonly>
                                @error('ktrgn_drh')
                                <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="form-group row">
                      <div class="col-sm-4 mb-3 mb-sm-0">
                          ...
                          <input type="text" class="form-control @error('suhu') is-invalid @enderror" id="suhu" name="suhu" placeholder="Suhu Tubuh" value="{{ old('suhu', $anamripasien->suhu) }}" required disabled readonly>
                              @error('suhu')
                              <span class="invalid-feedback" role="alert">
                              <strong>{{ $message }}</strong>
                              </span>
                      ...
                      <div class="col-sm-6 mb-3">
                        ...
                        <select class="form-control @error('pernafasan') is-invalid @enderror" id="pernafasan" name="pernafasan" placeholder="Pernafasan" value="{{ old('pernafasan') }}" required disabled readonly>
                                @error('pernafasan')
                                <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="form-group row">
                      <div class="col-sm-4 mb-3">
                        ...
                        <select class="form-control @error('jantung') is-invalid @enderror" id="jantung" name="jantung" placeholder="Jantung" value="{{ old('jantung') }}" required disabled readonly>
                                @error('jantung')
                                <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                                </span>
                      ...
                      <div class="col-sm-4 mb-3">
                        ...
                        <select class="form-control @error('diabetes') is-invalid @enderror" id="diabetes" name="diabetes" placeholder="Diabetes" value="{{ old('diabetes') }}" required disabled readonly>
                                @error('diabetes')
                                <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                                </span>
                      ...
                      <div class="col-sm-4 mb-3">
                        ...
                        <select class="form-control @error('haemophilia') is-invalid @enderror" id="haemophilia" name="haemophilia" placeholder="Haemophilia" value="{{ old('haemophilia') }}" required disabled readonly>
                                @error('haemophilia')
                                <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="form-group row">
                      <div class="col-sm-6 mb-3">
                        ...
                        <select class="form-control @error('hepatitis') is-invalid @enderror" id="hepatitis" name="hepatitis" placeholder="Hepatitis" value="{{ old('hepatitis') }}" required disabled readonly>
                                @error('hepatitis')
                                <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                                </span>
                      ...
                      <div class="col-sm-6 mb-3">
                        ...
                        <select class="form-control @error('lambung') is-invalid @enderror" id="lambung" name="lambung" placeholder="Lambung/Maag" value="{{ old('lambung') }}" required disabled readonly>
                                @error('lambung')
                                <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="form-group row">
                      <div class="col-sm-6 mb-3">
                        ...
                        <select class="form-control @error('pnykt_ln') is-invalid @enderror" id="pnykt_ln" name="pnykt_ln" placeholder="Penyakit Lainnya" value="{{ old('pnykt_ln') }}" required disabled readonly>
                                @error('pnykt_ln')
                                <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                                </span>
                      ...
                      <div class="col-sm-6 mb-3 mb-sm-0">
                        ...
                        <input type="text" class="form-control @error('nm_pnykt_ln') is-invalid @enderror" id="nm_pnykt_ln" name="nm_pnykt_ln" disabled readonly placeholder="Tuliskan Nama Penyakitnya" value="{{ old('nm_pnykt_ln', $anamripasien->nm_pnykt_ln) }}">
                            @error('nm_pnykt_ln')
                            <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="col-sm-12 mb-3 mb-sm-0 text-center">
                      ...
                      <div class="form-group row">
                        <div class="col-sm-6 mb-3">
                          ...
                          <select class="form-control @error('alergi_obat') is-invalid @enderror" id="alergi_obat" name="alergi_obat" placeholder="Masukan Nama Obat" value="{{ old('alergi_obat') }}" required disabled readonly>
                                  @error('alergi_obat')
                                  <span class="invalid-feedback" role="alert">
                                  <strong>{{ $message }}</strong>
                                  </span>
                        ...
                        <div class="col-sm-6 mb-3 mb-sm-0">
                          ...
                          <input type="text" class="form-control @error('nm_obat') is-invalid @enderror" id="nm_obat" name="nm_obat" disabled readonly placeholder="Tuliskan Nama Obat nya" value="{{ old('nm_obat', $anamripasien->nm_obat) }}">
                              @error('nm_obat')
                              <span class="invalid-feedback" role="alert">
                              <strong>{{ $message }}</strong>
                              </span>
                        ...
                        <div class="form-group row">
                          <div class="col-sm-6 mb-3">
                            ...
                            <select class="form-control @error('alergi_mkn') is-invalid @enderror" id="alergi_mkn" name="alergi_mkn" disabled readonly placeholder="Alergi Makanan" value="{{ old('alergi_mkn') }}" required>
                                    @error('alergi_mkn')
                                    <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                    </span>
                          ...
                          <div class="col-sm-6 mb-3 mb-sm-0">
                            ...
                            <input type="text" class="form-control @error('nm_mkn') is-invalid @enderror" id="nm_mkn" name="nm_mkn" disabled readonly placeholder="Tuliskan Nama Makanannya" value="{{ old('nm_mkn', $anamripasien->nm_mkn) }}">
                                @error('nm_mkn')
                                <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6 d-grid gap-2">
                            <a href="{{route('anamripasien.edit', $anamripasien->id)}}" class="btn btn-primary btn-block btn">
