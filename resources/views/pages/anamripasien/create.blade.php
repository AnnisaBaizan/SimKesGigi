            ...
            <div class="card-body">
                ...
                {{-- <div class="col-sm-12 mb-3">
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control @error('klhn_utama') is-invalid @enderror" id="klhn_utama" name="klhn_utama" placeholder="Masukan Keluhan Utama Anda">{{ old('klhn_utama') }}</textarea>
                        @error('klhn_utama')
                        <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <div class="col-sm-12 mb-3 mb-sm-0">
                      ...
                      <textarea class="form-control @error('klhn_tmbhn') is-invalid @enderror" id="klhn_tmbhn" name="klhn_tmbhn" placeholder="Masukan Keluhan Tambahan Anda">{{ old('alamat') }}</textarea>
                          @error('klhn_tmbhn')
                          <span class="invalid-feedback" role="alert">
                          <strong>{{ $message }}</strong>
                          </span>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-4 mb-3 mb-sm-0">
                      ...
                      <input type="text" class="form-control @error('nadi') is-invalid @enderror" id="nadi" name="nadi" placeholder="Denyut Nadi" value="{{ old('nadi') }}" required>
                          @error('nadi')
                          <span class="invalid-feedback" role="alert">
                          <strong>{{ $message }}</strong>
                          </span>
                    ...
                    <div class="form-group row">
                      <div class="col-sm-4 mb-3 mb-sm-0">
                          ...
                          <input type="text" class="form-control @error('tknn_drh') is-invalid @enderror" id="tknn_drh" name="tknn_drh" placeholder="00/00" value="{{ old('tknn_drh') }}" required>
                              @error('tknn_drh')
                              <span class="invalid-feedback" role="alert">
                              <strong>{{ $message }}</strong>
                              </span>
                    ...
                    <div class="form-group row">
                      <div class="col-sm-4 mb-3 mb-sm-0">
                          ...
                          <input type="text" class="form-control @error('suhu') is-invalid @enderror" id="suhu" name="suhu" placeholder="Suhu Tubuh" value="{{ old('suhu') }}" required>
                              @error('suhu')
                              <span class="invalid-feedback" role="alert">
                              <strong>{{ $message }}</strong>
                              </span>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-6 mb-3 mb-sm-0">
                        ...
                        <input type="text" class="form-control @error('nm_pnykt_ln') is-invalid @enderror" id="nm_pnykt_ln" name="nm_pnykt_ln" placeholder="Tuliskan Nama Penyakitnya" value="{{ old('nm_pnykt_ln') }}" disabled>
                            @error('nm_pnykt_ln')
                            <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="col-sm-12 mb-3 mb-sm-0 text-center">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-6 mb-3 mb-sm-0">
                          ...
                          <input type="text" class="form-control @error('nm_obat') is-invalid @enderror" id="nm_obat" name="nm_obat" placeholder="Tuliskan Nama Obat nya" value="{{ old('nm_obat') }}" disabled>
                              @error('nm_obat')
                              <span class="invalid-feedback" role="alert">
                              <strong>{{ $message }}</strong>
                              </span>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-6 mb-3 mb-sm-0">
                            ...
                            <input type="text" class="form-control @error('nm_mkn') is-invalid @enderror" id="nm_mkn" name="nm_mkn" placeholder="Tuliskan Nama Makanannya" value="{{ old('nm_mkn') }}" disabled>
                                @error('nm_mkn')
                                <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                                </span>
