...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Tambah Anamnesa dan Riwayat Pasien'])

    <div class="container-fluid py-4">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Formulir Anamnesa dan Riwayat Pasien</h6>
            </div>
            <div class="card-body">
                <form class="user" action="{{ route('anamripasien.store') }}" method="post">
                    @csrf
                    ...
                    <div class="form-group">
                        <div class="col-sm-12 mb-3 mb-sm-0">
                            ...
                            <textarea class="form-control @error('klhn_utama') is-invalid @enderror" id="klhn_utama" name="klhn_utama"
                                placeholder="Masukan Keluhan Utama Anda">{{ old('klhn_utama') }}</textarea>
                            @error('klhn_utama')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="col-sm-12 mb-3 mb-sm-0">
                            ...
                            <textarea class="form-control @error('klhn_tmbhn') is-invalid @enderror" id="klhn_tmbhn" name="klhn_tmbhn"
                                placeholder="Masukan Keluhan Tambahan Anda">{{ old('alamat') }}</textarea>
                            @error('klhn_tmbhn')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4 mb-3 mb-sm-0">
                            ...
                            <input type="text" class="form-control @error('nadi') is-invalid @enderror" id="nadi"
                                name="nadi" placeholder="Denyut Nadi" value="{{ old('nadi') }}" required>
                            @error('nadi')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-4 mb-3 mb-sm-0">
                            ...
                            <input type="text" class="form-control @error('tknn_drh') is-invalid @enderror"
                                id="tknn_drh" name="tknn_drh" placeholder="00/00" value="{{ old('tknn_drh') }}"
                                required>
                            @error('tknn_drh')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-4 mb-3 mb-sm-0">
                            ...
                            <input type="text" class="form-control @error('suhu') is-invalid @enderror"
                                id="suhu" name="suhu" placeholder="Suhu Tubuh" value="{{ old('suhu') }}"
                                required>
                            @error('suhu')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            ...
                            <input type="text" class="form-control @error('nm_pnykt_ln') is-invalid @enderror"
                                ...
                                value="{{ old('nm_pnykt_ln') }}" disabled>
                            @error('nm_pnykt_ln')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
