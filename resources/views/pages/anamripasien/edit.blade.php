            ...
            <div class="card-body">
                <form class="user" action="{{ route('anamripasien.update', $anamripasien->id) }}" method="post">
                            ...
                            <div class="col-sm-8">
                                <select
                                    ...
                                    @foreach ($kartupasiens as $kartupasien)
                                        <option value="{{ $anamripasien->kartupasien_id }}" {{ $anamripasien->kartupasien_id == $kartupasien->id ? 'selected' : '' }} data-pembimbing="{{ $kartupasien->pembimbing }}">{{ $kartupasien->no_kartu }} |
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <select
                                    ...
                                    @foreach ($kartupasiens as $kartupasien)
                                        <option value="{{ $kartupasien->id }}" {{ $anamripasien->kartupasien_id == $kartupasien->id ? 'selected' : '' }} data-pembimbing="{{ $kartupasien->pembimbing }}">{{ $kartupasien->no_kartu }} |
                                            {{ $kartupasien->nama }}</option>
                                    @endforeach
                                </select>
                            </div>
                    ...
                    <div class="col-sm-12 mb-3 mb-sm-0 text-center bg-gradient-faded-info-vertical">
                        <marquee>
                            <h6 class="m-0 font-weight-bold text-dark text-bold">Anamnesa</h6>
                        </marquee>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-12 mb-3 mb-sm-0">
                            <label for="klhn_utama" class ="form-text">Keluhan Utama :</label>
                            <textarea class="form-control @error('klhn_utama') is-invalid @enderror" id="klhn_utama" name="klhn_utama"
                                placeholder="Masukan Keluhan Utama Anda">{{ old('klhn_utama', $anamripasien->klhn_utama) }}</textarea>
                            @error('klhn_utama')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="col-sm-12 mb-3 mb-sm-0">
                            ...
                            <textarea class="form-control @error('klhn_tmbhn') is-invalid @enderror" id="klhn_tmbhn" name="klhn_tmbhn"
                                placeholder="Masukan Keluhan Tambahan Anda">{{ old('klhn_tmbhn', $anamripasien->klhn_tmbhn) }}</textarea>
                            @error('klhn_tmbhn')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="col-sm-12 mb-3 mb-sm-0 text-center bg-gradient-faded-info-vertical">
                        <marquee>
                            <h6 class="m-0 font-weight-bold text-dark text-bold">Riwayat Kesehatan Umum</h6>
                        </marquee>
                    </div>
                    <div class="form-group row">
                        <div class="col-sm-6 mb-3">
                            <label for="goldar" class ="form-text">Golongan Darah :</label>
                            <select class="form-control @error('goldar') is-invalid @enderror" id="goldar"
                                name="goldar" placeholder="Golongan Darah" value="{{ old('goldar') }}" required>
                                @error('goldar')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-4 mb-3 mb-sm-0">
                            ...
                            <input type="text" class="form-control @error('tknn_drh') is-invalid @enderror"
                                id="tknn_drh" name="tknn_drh" placeholder="00/00"
                                value="{{ old('tknn_drh', $anamripasien->tknn_drh) }}" required>
                            @error('tknn_drh')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="col-sm-6 mb-3">
                            ...
                            <select class="form-control @error('ktrgn_drh') is-invalid @enderror" id="ktrgn_drh"
                                name="ktrgn_drh" placeholder="Keterangan" value="{{ old('ktrgn_drh') }}" required>
                                @error('ktrgn_drh')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <option value="Normal" {{ $anamripasien->ktrgn_drh == 'Normal' ? 'selected' : '' }}>Normal
                                </option>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-4 mb-3 mb-sm-0">
                            ...
                            <input type="text" class="form-control @error('suhu') is-invalid @enderror"
                                id="suhu" name="suhu" placeholder="Suhu Tubuh"
                                value="{{ old('suhu', $anamripasien->suhu) }}" required>
                            @error('suhu')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="col-sm-6 mb-3">
                            ...
                            <select class="form-control @error('pernafasan') is-invalid @enderror" id="pernafasan"
                                name="pernafasan" placeholder="Pernafasan" value="{{ old('pernafasan') }}" required>
                                @error('pernafasan')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <option value="Normal" {{ $anamripasien->pernafasan == 'Normal' ? 'selected' : '' }}>Normal
                                </option>
                                <option value="Sesak" {{ $anamripasien->pernafasan == 'Sesak' ? 'selected' : '' }}>Sesak
                                </option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-4 mb-3">
                            ...
                            <select class="form-control @error('jantung') is-invalid @enderror" id="jantung"
                                name="jantung" placeholder="Jantung" value="{{ old('jantung') }}" required>
                                @error('jantung')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="col-sm-4 mb-3">
                            ...
                            <select class="form-control @error('diabetes') is-invalid @enderror" id="diabetes"
                                name="diabetes" placeholder="Diabetes" value="{{ old('diabetes') }}" required>
                                @error('diabetes')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <option value="Tidak Ada" {{ $anamripasien->diabetes == 'Tidak Ada' ? 'selected' : '' }}>
                                    Tidak Ada</option>
                            </select>
                        </div>
                        <div class="col-sm-4 mb-3">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-6 mb-3">
                            ...
                            <select class="form-control @error('hepatitis') is-invalid @enderror" id="hepatitis"
                                name="hepatitis" placeholder="Hepatitis" value="{{ old('hepatitis') }}" required>
                                @error('hepatitis')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="col-sm-6 mb-3">
                            ...
                            <select class="form-control @error('lambung') is-invalid @enderror" id="lambung"
                                name="lambung" placeholder="Lambung/Maag" value="{{ old('lambung') }}" required>
                                @error('lambung')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-6 mb-3">
                            ...
                            <select class="form-control @error('pnykt_ln') is-invalid @enderror" id="pnykt_ln"
                                ...
                                <option value="Tidak Ada" {{ $anamripasien->pnykt_ln == 'Tidak Ada' ? 'selected' : '' }}>
                                    Tidak Ada</option>
                            </select>
                        </div>
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            ...
                            <input type="text" class="form-control @error('nm_pnykt_ln') is-invalid @enderror"
                                id="nm_pnykt_ln" name="nm_pnykt_ln" placeholder="Tuliskan Nama Penyakitnya"
                    ...
                    <div class="form-group row">
                        <div class="col-sm-6 mb-3">
                            ...
                            <select class="form-control @error('alergi_obat') is-invalid @enderror" id="alergi_obat"
                                name="alergi_obat" placeholder="Masukan Nama Obat" value="{{ old('alergi_obat') }}"
                                required>
                                @error('alergi_obat')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                        ...
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            ...
                            <input type="text" class="form-control @error('nm_obat') is-invalid @enderror"
                                id="nm_obat" name="nm_obat" placeholder="Tuliskan Nama Obat nya"
                    ...
                    <div class="form-group row">
                        <div class="col-sm-6 mb-3">
                            ...
                            <select class="form-control @error('alergi_mkn') is-invalid @enderror" id="alergi_mkn"
                                name="alergi_mkn" placeholder="Alergi Makanan" value="{{ old('alergi_mkn') }}" required>
                                @error('alergi_mkn')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            ...
                            <input type="text" class="form-control @error('nm_mkn') is-invalid @enderror"
                                id="nm_mkn" name="nm_mkn" placeholder="Tuliskan Nama Makanannya"
