        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <p>Apakah kamu yakin menghapus Kartu Pasien?</p><br>
              <p class="text-danger">AKAN MENGHAPUS SELURUH DATA PEMERIKSAAN DAN HASIL</p>
            </div>
                            ...
                            <table class="table align-items-center mb-0" id="dataTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="display: none;">{{ $kartupasien->alamat }}</td>
                                        <td>{{ strlen($kartupasien->alamat) > 25 ? substr($kartupasien->alamat, 0, 25) . ' . . .' : $kartupasien->alamat }}</td>
