                        ...
                        <div class="form-group row justify-content-center">
                            ...
                            <div class="col-sm-4">
                                <select class="js-example-basic-single form-control @error('pembimbing') is-invalid @enderror"
                                    data-live-search="true" id="pembimbing" name="pembimbing" placeholder="Pilih Pasien"
                                    ...
                                    @foreach ($pembimbings as $pembimbing)
                                        <option value="{{ $pembimbing->nimnip }}">{{ $pembimbing->nimnip }} |
                                            {{ $pembimbing->username }}</option>
                                    @endforeach
                                </select>
                    ...
                    <div class="form-group row justify-content-center">
                        <div class="col-sm-4">
                            ...
                            <input type="text" class="form-control text-center @error('no_kartu') is-invalid @enderror"
                                ...
                                value="{{ old('no_kartu') }}" required readonly>
                            @error('no_kartu')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" class="form-control @error('no_iden') is-invalid @enderror" id="no_iden"
                                name="no_iden" placeholder="Nomor Identitas" value="{{ old('no_iden') }}" required>
                            @error('no_iden')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input type="date" class="form-control @error('tgl_lhr') is-invalid @enderror"
                                id="tgl_lhr" name="tgl_lhr" placeholder="Tanggal lahir" value="{{ old('tgl_lhr') }}"
                                required>
                            @error('tgl_lhr')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control @error('umur') is-invalid @enderror" id="umur"
                                name="umur" placeholder="Umur" value="{{ old('umur') }}" readonly required>
                            @error('umur')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-6">
                            ...
                            <select class="form-control @error('jk') is-invalid @enderror" id="jk" name="jk"
                                placeholder="Jenis Kelamin" value="{{ old('jk') }}" required>
                                @error('jk')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" class="form-control @error('suku') is-invalid @enderror"
                                id="suku" name="suku" placeholder="Suku/Ras" value="{{ old('suku') }}"
                                required>
                            @error('suku')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            ...
                            <input type="text" class="form-control @error('pekerjaan') is-invalid @enderror"
                                id="pekerjaan" name="pekerjaan" placeholder="Pekerjaan" value="{{ old('pekerjaan') }}"
                                required>
                            @error('pekerjaan')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" class="form-control @error('hub') is-invalid @enderror" id="hub"
                                name="hub" placeholder="Keluarga yang Dapat Dihubungi" value="{{ old('hub') }}"
                                required>
                            @error('hub')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-6">
                            ...
                            <input type="text" class="form-control @error('no_hp') is-invalid @enderror"
                                id="no_hp" name="no_hp" placeholder="Nomor Handphone" value="{{ old('no_hp') }}"
                                required>
                            @error('no_hp')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" class="form-control @error('no_tlpn') is-invalid @enderror"
                                id="no_tlpn" name="no_tlpn" placeholder="Nomor Telepon" value="{{ old('no_tlpn') }}"
                                required>
                            @error('no_tlpn')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
